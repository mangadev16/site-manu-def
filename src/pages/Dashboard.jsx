          ...
          <div className="flex-1 lg:flex-none flex flex-col lg:grid lg:grid-cols-3 gap-3 lg:gap-8 w-full mb-6 lg:mb-12">
            {servicos.map((s) => (
              <div
                ...
                className="flex-1 lg:flex-none bg-white p-5 lg:p-8 rounded-[25px] lg:rounded-[40px] border-2 border-emerald-100 shadow-sm flex flex-row lg:flex-col items-center lg:text-center gap-4 lg:gap-6 hover:shadow-md transition-all"
              >
                ...
                <div className="flex flex-col lg:items-center">
                  <h3 className="font-bold text-base lg:text-2xl text-gray-800 leading-tight">
                    {s.nome}
                  </h3>
                  <p className="text-gray-500 text-[11px] lg:text-sm leading-tight lg:mt-3 lg:px-2">
                    {s.desc}
                  </p>
                </div>
              </div>
