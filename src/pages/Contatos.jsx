...
import { Mail, Phone, MessageCircle, Instagram, Globe, User, Code, Smartphone, Github } from "lucide-react";
            ...
            {contatos.map((contato, index) => (
              ...
              >
                ...
                <div className="p-5 space-y-3">
                  <a href={`mailto:${contato.email}`} className="flex items-center gap-3 text-sm text-gray-600 hover:text-emerald-600 transition-colors group">
                  ...
                  {contato.telefone && (
                    <>
                      <a href={`tel:${contato.telefone}`} className="flex items-center gap-3 text-sm text-gray-600 hover:text-emerald-600 transition-colors group">
                        <Phone size={16} className="text-gray-400 group-hover:text-emerald-600" />
                        <span className="flex-1">{contato.telefone}</span>
                      </a>
                      <a href={`https://wa.me/${contato.whatsapp}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-gray-600 hover:text-emerald-600 transition-colors group">
                  ...
                  {contato.site && (
                    <a href={`https://${contato.site}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-gray-600 hover:text-emerald-600 transition-colors group">
                  ...
                  {contato.portfolio && (
                    <a href={`https://${contato.portfolio}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-gray-600 hover:text-emerald-600 transition-colors group">
                      <Globe size={16} className="text-gray-400 group-hover:text-emerald-600" />
                  ...
                  {contato.github && (
                    <a href={`https://${contato.github}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-gray-600 hover:text-emerald-600 transition-colors group">
